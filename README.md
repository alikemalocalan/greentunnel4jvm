...
- **Aggressive Mode (Connection Padding)** — Optional TLS ClientHello padding (RFC 7685) to standard packet sizes to obscure packet size fingerprinting (new feature for Russian users but not tested)
